...
import { Cards, TypicalData } from "../utils/data";
    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute right-0 left-0 -bottom-10 flex flex-col justify-center items-center text-white">
                    <div className="flex bg-black bg-opacity-85 px-4 py-2 rounded-xl">
                        ...
                        <div>
                            <p className="text-[10px] font-light  text-slate-300 ml-4">
                                Trạng thái
                            </p>
                            <Dropdown
            ...
            <div className="px-12 flex flex-col items-center justify-center gap-32 mt-28 text-black">
                <div>
                    <h2 className="w-full text-center font-bold mb-8 text-2xl">
                        Dự Án Nỗi Bật
                    </h2>
            ...
            >
                <div className="absolute inset-0 flex flex-col justify-center items-center p-4">
                    ...
                    <p className="text-center text-xs mt-2">
                        Pellentesque egestas elementum <br /> egestas faucibus
                        sem. Velit nunc egestas ut morbi. Leo diam diam
                    </p>
